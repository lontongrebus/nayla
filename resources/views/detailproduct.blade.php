...
<body class="goto-here">
    ...
    @php
        $detail = DB::table('barangs')->where('id', $id)->first();
        // dd($detail);
    @endphp
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 ftco-animate">
                    ...
                    @foreach (json_decode($detail->foto) as $i => $item)
                        @php
                            $i += 1;
                        @endphp

                        <a href="{{ Storage::url($item) }}" class="image-popup">
                            <img src="{{ Storage::url($item) }}" class="img-fluid" alt="Colorlib Template"
                ...
                <div class="col-lg-6 product-details pl-md-5 ftco-animate">
                    ...
                    <p class="price"><span>RP. {{ number_format($detail->harga_jual, 2) }}</span></p>
                    ...
                    <p>
                        ...
                        <a href="{{ url('addToKeranjang/' . $id) }}" href="cart.html"
                            class="btn btn-black py-3 px-5">Add to Cart </a>
                    </p>
                </div>
            </div>
        </div>
