        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item cta cta-colored"><a href="{{ url('/keranjang') }}" class="nav-link"><span
                    ...
                    <div class="col-md-6 col-lg-3 ftco-animate">
                        <div class="product">
                            <a href="#" class="img-prod">
                                @foreach (json_decode($value->foto) as $i => $item)
                                    @php
                                        $i += 1;
                                    @endphp

                                    @if ($i == 1)
                                        <img class="img-fluid" src="{{ Storage::url($item) }}"
                            ...
                            <div class="text py-3 pb-4 px-3 text-center">
                                ...
                                <div class="d-flex">
                                    <div class="pricing">
                                        <p class="price">
                                            <span>{{ 'Rp' . number_format($value->harga_jual, 2, ',', ',') }}</span>
                                        </p>
                                    </div>
                                </div>
                                <div class="bottom-area d-flex px-3">
                                    <div class="m-auto d-flex">
                                        <a href="{{ url('barang/detail/' . $value->id) }}"
